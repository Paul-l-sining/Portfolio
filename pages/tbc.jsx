        ...
        <div className="w-full">
          ...
          <div className="max-w-[1240px] p-2 grid lg:grid-cols-5 gap-8 pt-8 mx-2">
            <div className="lg:col-span-4">
              ...
              <a href="" target="_blank"><button className="px-8 py-2 mt-4 mr-8 hover:scale-105 duration-300">Demo</button></a>
              <a href="" target="_blank"><button className="px-8 py-2 mt-4 hover:scale-105 duration-300">Code</button></a>
            </div> 
